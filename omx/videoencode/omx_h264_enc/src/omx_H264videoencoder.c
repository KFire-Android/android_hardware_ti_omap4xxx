            ...
            if(((OMX_VIDEO_PARAM_AVCTYPE *)pParamStruct)->nPortIndex == OMX_H264VE_OUTPUT_PORT ) {
                switch(((OMX_VIDEO_PARAM_PROFILELEVELTYPE *)pParamStruct)->nProfileIndex ) {
                    case 0 :
                        ...
                        ((OMX_VIDEO_PARAM_PROFILELEVELTYPE *)pParamStruct)->eLevel = OMX_VIDEO_AVCLevel42;
                        break;
                    case 1 :
    ...
    switch( nParamIndex ) {
        ...
        case OMX_IndexParamPortDefinition :
            ...
            if( nPortIndex == OMX_H264VE_INPUT_PORT ) {
                ...
                OMX_CHECK((pPortDef->format.video.eColorFormat == OMX_TI_COLOR_FormatYUV420PackedSemiPlanar), OMX_ErrorUnsupportedSetting);
